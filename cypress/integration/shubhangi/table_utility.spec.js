...
//integration -spec file- > import assertFunc from "../../utility/assertion";
import utilmethods from './buisenesMethods';
...
it('vrify the structure of the buldinkg and their Ranks', () => {
    ...
    it('vrify the structure of the buldinkg and their countries', () => {
        var buildArr = ['Burj Khalifa','Clock Tower Hotel','Taipei 101','Financial Center']
         ...
         //////////////////////////////////////////////////////////////////
    //create 1 file in ur project folde for utilitymthods->     
    class utilmethods{
       ...
       // export default utilmethods;
        ...
        //add below code in ur utility assertions file- > class assertFunc{
